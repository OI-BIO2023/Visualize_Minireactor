  ...
  return (
    <section className="panel">
      <div className="panel-header">
        <div>
          <h2>Globale AnlagenÃ¼bersicht</h2>
          <p className="muted">Letzter Datenpunkt: {lastTimestamp ?? 'kein gÃ¼ltiger Wert'}</p>
        </div>
        <div className="chip-row">{flags.length ? <span className="status-badge warning">DatenqualitÃ¤t beachten</span> : <span className="status-badge success">Daten sauber</span>}</div>
      </div>
      {flags.length ? (
