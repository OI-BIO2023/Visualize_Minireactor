  ...
  return (
    <section className="panel">
      <div className="panel-header">
        ...
        <div className="chip-row">{flags.length ? <span className="status-badge warning">Datenqualität beachten</span> : <span className="status-badge success">Daten sauber</span>}</div>
      </div>
      {flags.length ? (
