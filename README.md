...
The stale alert job is hardcoded for `oi@biologik.it` and a 60 minute threshold. It stays inactive until the scheduled function is deployed and triggered.
